...
매일 하나의 키워드와 관련 아티클을 HN·GeekNews·velog·Velopers에서 자동 수집해 제공합니다.
...
| `DevPick-Collect`  | 매일 21:00        | ① 다음날 키워드로 HN·GeekNews·velog·Velopers 글 수집 + AI 분석<br>② HN·dev.to·Velopers 24시간 인기글 수집 + AI 분석 → 7일 히스토리 보관 |

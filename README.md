...
매일 하나의 키워드와 관련 아티클을 HN·dev.to·GeekNews·velog·Velopers에서 자동 수집해 제공합니다.

## 주요 기능

- **오늘의 키워드** — 매일 선정된 기술 키워드와 관련 아티클 (한국어·영어 필터)
- **트렌딩** — HN·dev.to·Velopers 인기글을 카테고리별로 탐색 (최근 7일 히스토리 보관)
- **모아보기** — 지난 7일치 키워드·추천 아티클·트렌딩을 날짜별로 되돌아보기
...
| `DevPick-Collect`  | 매일 21:00        | ① 다음날 키워드로 HN·dev.to·GeekNews·velog·Velopers 글 수집 + AI 분석<br>② HN·dev.to·Velopers 24시간 인기글 수집 + AI 분석 → 7일 히스토리 보관 |
